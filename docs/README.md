# Resume-to-Interview-R2I

Migrated from Hugging Face Spaces.

## Original Space

- URL: https://huggingface.co/spaces/Chris4K/Resume-to-Interview-R2I
- SDK: gradio
...
1. **Private Monorepo** (development)
   - Location: `apps/huggingface/Resume-to-Interview-R2I/`
   - All development happens here
   - Contains secrets and private configuration

2. **Public GitHub Repository**
   - URL: https://github.com/Ckal/Resume-to-Interview-R2I
